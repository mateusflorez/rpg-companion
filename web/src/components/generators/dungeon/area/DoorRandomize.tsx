...
function DoorRandomize() {
    ...
    if (randomizedDices[1] < 21) {
        ...
        door = "Locked and trapped stone door. " + TrapRandomize() + "  DC 15 perception to find trap. If trap disarmed / avoided / triggered, opens onto " + temp2
        ...
        door = "Trapped door. " + TrapRandomize() + " DC 15 perception to find trap. If trap disarmed / avoided / triggered, opens onto " + temp2
