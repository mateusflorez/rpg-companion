...
function Characters() {
    ...
    const navigateToCharacterSheet = (id: string) => {
            ...
            <div className="pt-8 grid grid-cols-3 gap-8">
                {
                    characters && characters.map((character: any, index: any) => {
                        return (
                            <div className="pt-1 bg-orange-600 rounded-lg w-full overflow-hidden" onClick={() => { navigateToCharacterSheet(character.id) }}>
                                <div className='bg-cloudy px-4 py-4 rounded-t h-full transition hover:bg-rainy' >
                                    <div className="flex flex-row justify-between pb-2">
                                        ...
                                        <button onClick={(e) => { e.stopPropagation(); deleteButton(character) }}>
